...
class TechnologyFingerprinter(BaseModule):
    ...
    _VULN_DB: Dict[str, Dict] = {
        ...
        "jQuery":    {"min": "3.7.0",  "sev": "Medium", "desc": "Outdated jQuery has known security and prototype-pollution vulnerabilities"},
        "Bootstrap": {"min": "5.3.0",  "sev": "Low",    "desc": "Outdated Bootstrap may have minor security vulnerabilities"},
